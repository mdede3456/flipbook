...
<body class="product-template-default single single-product postid-16526 theme-bookio woocommerce woocommerce-page woocommerce-no-js life-you-are banners-effect-1 elementor-default elementor-kit-9482 dokan-theme-bookio">
                        ...
                        <div class="contents-detail">
                            <div class="main-single-product box">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                    ...
                                    <div id="product-16526" class="post-16526 product type-product status-publish has-post-thumbnail product_author-seamus-rosenbaum product_brand-slocan product_cat-fantasy product_cat-modern-fiction product_tag-hot product_tag-trend first instock sale shipping-taxable purchasable product-type-simple">
                                        <div class="bwp-single-product zoom" data-product_layout_thumb="zoom" data-zoom_scroll="true" data-zoom_contain_lens="true" data-zoomtype="inner" data-lenssize="200" data-lensshape="square" data-lensborder="1" data-bordersize="2" data-bordercolour="#ff3535">
                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-2">
                                                                    <div id="image-thumbnail" class="image-thumbnail slick-carousel" data-infinite="true" data-columns4="4" data-columns3="4" data-columns2="4" data-columns1="4" data-columns="4" data-nav="true" data-vertical=&quot;true&quot; data-verticalswiping=&quot;true&quot;>
                                                                        <div class="img-thumbnail">
                                                                            <a href="{{asset($comic->thumbnail)}}" data-image="{{asset($comic->thumbnail)}}" class="img-thumbnail first active" title="">
                                                                                <img width="480" height="693" src="{{asset($comic->thumbnail)}}" class="attachment-shop_catalog size-shop_catalog" alt="Image-20" loading="lazy" title="Image-20" data-zoom-image="{{asset($comic->thumbnail)}}" />
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-10">
                                                                    <div class="image-additional active text-center">
                                                                        <div data-thumb="{{asset($comic->thumbnail)}}" class="woocommerce-product-gallery__image">
                                                                            <img width="720" height="1040" src="{{asset($comic->thumbnail)}}" class="attachment-shop_single size-shop_single wp-post-image" alt="" loading="lazy" id="image" title="" data-src="{{asset($comic->thumbnail)}}" data-large_image="{{asset($comic->thumbnail)}}" data-large_image_width="720" data-large_image_height="1040" />
                                                                        </div>
                                                ...
                                                <div class="bwp-single-info col-lg-6 col-md-12 col-12 ">
                                                    <div class="summary entry-summary">
                                                        <h1 itemprop="name" class="product_title entry-title">{{$comic->name}}</h1>
                                                        <div class="brands-single">
                                                            <div class="title-brand">Genre :</div>
                                                        ...
                                                        <div class="social-icon"><label>Share : </label>
                                                            <div class="social-share">
                                                                <a href="https://www.facebook.com/sharer/sharer.php?u={{url()->current()}}" title="Facebook" class="share-facebook" target="_blank"><i class="fa fa-facebook"></i></a>
                                                                <a href="https://twitter.com/intent/tweet/?text={{$comic->name}}&url={{url()->current()}}" title="Twitter" class="share-twitter"><i class="fa fa-twitter"></i></a>
                                                                <a href="https://api.whatsapp.com/send?text={{$comic->name}}%0A%0A{{url()->current()}}" title="LinkedIn" class="share-linkedin"><i class="fa fa-whatsapp"></i></a>
                                            ...
                                            <div class="content-woocommerce-tabs">
                                                <div class="content-ul-tab">
                                                    <ul class="tabs wc-tabs" role="tablist">
                                                        <li class="description_tab" id="tab-title-description" role="tab" aria-controls="tab-description"> <a href="#tab-description"> List Chapter </a></li>
                                                    </ul>
                                                </div>
                                                <div class="content-tab">
                                                    <div class="woocommerce-Tabs-panel woocommerce-Tabs-panel--description panel entry-content wc-tab" id="tab-description" role="tabpanel" aria-labelledby="tab-title-description">
                                                        <table class="table">
                                                            @foreach($comic->chapter as $c)
                                                            <tr>
                                                                <th>
                                                                    <a href="{{route('comic.read',[$c->id,strtolower(preg_replace("/[^a-zA-Z0-9]/", "-", $c->name))])}}">{{$c->name}} - <i class="fa fa-eye"></i> Dilihat ( {{count($c->viewer)}} )</a>
                                                                </th>
                                                            </tr>
                                                            @endforeach
                                                        </table>
