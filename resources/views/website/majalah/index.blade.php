                ...
                <div class="col-xl-9 col-lg-9 col-md-12 col-12">
                    ...
                    <div class="bestseller-product">
                        ...
                        <div class="slick-carousel products-list grid" data-slidestoscroll="true" data-nav="true" data-columns4="2" data-columns3="2" data-columns2="2" data-columns1="3" data-columns="4">
                            ...
                            <x-majalah.featured-component content="{{$trend->content}}"> </x-majalah.featured-component>
                            @endforeach
                        </div>
                    </div>
                                ...
                                <div class="products-entry content-product1 clearfix product-wapper">
                                    <div class="products-thumb">
                                        ...
                                        <div class="product-thumb-hover">
                                            <a href="{{route('majalah.detail',[$f->id,strtolower(preg_replace("/[^a-zA-Z0-9]/", "-", $f->title))])}}" class="woocommerce-LoopProduct-link">
                                                <img width="480" height="693" src="{{asset($f->thumbnail)}}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail wp-post-image" alt="" loading="lazy" />
                                                <img width="480" height="693" src="{{asset($f->thumbnail)}}" class="hover-image back" alt="" loading="lazy" />
                                            </a>
                                        </div>
                                        <div class='product-button'>
                                            <span class="product-quickview">
                                                <a href="{{route('majalah.detail',[$f->id,strtolower(preg_replace("/[^a-zA-Z0-9]/", "-", $f->title))])}}" class="quickview quickview-button quickview-16317">Quick View <i class="icon-view"></i></a>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="products-content">
                                        <div class="contents">
                                            <div class="">
                                                <div class=""></div>
                                                <div class=""><i class="fa fa-eye"></i> ( {{count($f->viewer)}} )</div>
                                            </div>
                                            <div class="list-author">By : <span class="item-author"><a href="{{route('author.detail',[$f->author_id,strtolower(preg_replace("/[^a-zA-Z0-9]/", "-", $f->author->name ?? 'none'))])}}">{{$f->author->name ?? ''}}</a></span></div>
                                            <h3 class="product-title"><a href="{{route('majalah.detail',[$f->id,strtolower(preg_replace("/[^a-zA-Z0-9]/", "-", $f->title))])}}">{{$f->title}}</a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bwp-top-bar top clearfix">
                            <div class="content-top">
                                <div class="content-title-heading">
                                    <h1 class="text-title-heading"> Other Book</h1>
                                </div>
                            </div>
