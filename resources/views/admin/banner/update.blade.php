                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title" value="{{$banner->title}}" placeholder="Banner Title" >
                                </div> 

                                <div class="form-group col-md-4">
                                    <label for="link">Link Url</label>
                                    <input type="url" name="link" class="form-control" id="link" value="{{$banner->link}}"   >
                                </div> 

                                <div class="form-group col-md-4">
                                    <label for="link">Banner Position</label>
                                    <select class="form-control" name="position">
                                        @foreach($type as $t => $value)
                                            <option value="{{$t}}" @if($t == $banner->position) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div> 
                            ...
                            <div class="form-row">  
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="file" name="banner" class="dropify" id="file" data-default-file="{{ asset($banner->banner) }}">
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $("form#cBanner").on("submit", function(e) {
            ...
            setTimeout(function() {
                $.ajax({
                    url: domain + "/admin/banner/store/update",
                    type: "POST",
                    data: formData,
                    success: function(data, json, errorThrown) {
                        if (data.message == "error") {
                            ...
                            toastr.success("Banner Website berhasil diperbaharui", "success", {
                                timeOut: 5e3,
                                closeButton: !0,
                                debug: !1,
                                newestOnTop: !0,
