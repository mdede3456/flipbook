                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="title" class="form-control" id="title" value="{{$slider->title}}" placeholder="Slider Title">
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="button" class="form-control" value="{{$slider->button}}" id="button" placeholder="Nama Button">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="file" name="image" class="dropify" id="file" data-default-file="{{ asset($slider->image) }}">
                            </div>
                        </div>
...
<script>
    ...
    $("form#cBanner").on("submit", function(e) {
        ...
        setTimeout(function() {
            $.ajax({
                url: domain + "/admin/slider/store/update"
                , type: "POST"
                , data: formData
                , success: function(data, json, errorThrown) {
                    if (data.message == "error") {
                        ...
                        toastr.success("Slider Website berhasil diperbaharui", "success", {
                            timeOut: 5e3
                            , closeButton: !0
                            , debug: !1
                            , newestOnTop: !0
