        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <form id="cTerm" method="POST" enctype="multipart/form-data" class="card">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title" placeholder="Page Title" value="{{$term->title}}">
                                </div> 
                            </div>
                            ...
                            <div class="form-row"> 
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="description" class="summernote-simple">{{$term->description}}</textarea>
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="file">Page Banner</label>
                                    <input type="file" name="banner" class="dropify" id="file" data-default-file="{{ asset($term->banner) }}">
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $("form#cTerm").on("submit", function(e) {
            spinner.show();
            e.preventDefault();
            var formData = new FormData(this);
            setTimeout(function() {
                $.ajax({
                    url: domain + "/admin/page/term-sett/store",
                    type: "POST",
                    data: formData,
                    success: function(data, json, errorThrown) {
                        if (data.message == "error") {
                            ...
                            toastr.success("Pengaturan Term Page Berhasil diperbaharui", "success", {
                                timeOut: 5e3,
                                closeButton: !0,
                                debug: !1,
                                newestOnTop: !0,
